...
public class NameOfGame
{
    ...
    public static void displayCurrentRoom()
    {
        switch( currentRoom )
        {
            case 1: // starting room
            {
                ...
                if( !pitchfork)
                {
                    System.out.println("There is a pitchfork laying on the ground.");   
                }
                break;
            }
            case 2: // crop circle
            ...
            case 3: //Computer room
            {
                ...
                if(!grenade)
                {
                    System.out.println("Behind the man next to the button you see a grenade.");
                }
                break;
            }
            case 4: // med bay
            {
                System.out.println(" When you enter the med bay you see a dark erie room full of medical supplies.");
                System.out.println(" You see many dead bodies, along with many things to help you on your travels");
                break;
            }
            case 5: // basement
            {
                System.out.println(" When you go into the basement you see something shiny in the back of the room");
                System.out.println(" When you go to get a closer look you see that there is a hoard of zombies, trying to attack you.");
                if(!cure)
                {
                 System.out.println("You see a vial of medicine. It looks like it could be the cure for a zombie virus.");
                 break;
                }
            }
            default:
    ...
    public static void takeItem()
    {
        ...
        switch( itemToGet )
        {
            ...
            {
                System.out.println("You grab the pitchfork and put it inside of your pack.");
                pitchfork = true;
                break;
            }
            case " gernade": 
            if ( currentRoom == grenadeLocation && !grenade )
            {
                System.out.println(" You grap the hand gernade and put it in your pack.");
                grenade = true;
                break;
            }
            case " cure": 
            if ( currentRoom == cureLocation && !cure) 
            {
                System.out.println( " You grap the cure from the room and put it in your pack.");
                cure = true;
                break;
            }
            default:
